...
namespace ArtworksClient_BrunoVidal.Utilities
{
    public static class Jeeves
    {
        //For Local API
        //public static Uri DBUri = new Uri("http://localhost:55450/");

        //For API on the Internet
        public static Uri DBUri = new Uri("https://project1brunovidal.azurewebsites.net/");
